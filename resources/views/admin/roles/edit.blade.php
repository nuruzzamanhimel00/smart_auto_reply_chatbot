...
@section('content')
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('roles.update',$role->id) }}" method="post" enctype="multipart/form-data" data-parsley-validate>
                        @csrf
                        @method('put')
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col-4 pt-1">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    {{count($all_permission_id) == count($role_permission)?'checked':''}}
                                    >
