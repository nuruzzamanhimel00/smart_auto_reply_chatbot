            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="site_title" id="site_title" required
                            placeholder="Enter site title" value="{{ config('settings.site_title') }}">
                        @error('site_title')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <label class="mb-2">{{ __('Timezone') }}</label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="imgInp">
                                    <img src="{{ config('settings.site_logo') ? getStorageImage(config('settings.site_logo'),false,'logo') : getDefaultLogo()}}"
                                        class="img-thumbnail img-70 object-contain" id="site_logo_preview" />
                                </label>
                                <input type="file" name="site_logo"
                                    {{ config('settings.site_logo') ? '' : 'required'  }}
                                    class="hdn-uploder image d-none" data-preview="site_logo_preview" id="imgInp"
                                    accept="image/*" />
                                @error('site_logo')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <label for="wide_site_logo">
                                    <img src="{{ config('settings.wide_site_logo') ? getStorageImage(config('settings.wide_site_logo'),false,'wide_logo') : getDefaultWideLogo() }}"
                                        class="img-thumbnail img-70 object-contain" id="wide_site_logo_preview" />
                                </label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="imgInpFavicom">
                                    <img src="{{ config('settings.site_favicon') ? getStorageImage(config('settings.site_favicon'),false,'favicon') : getDefaultFavicon()}}"
                                        class="img-thumbnail img-70 object-contain" id="site_favicon_preview" />
                                </label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="default_logo">
                                    <img src="{{ config('settings.default_logo') ? getStorageImage(config('settings.default_logo'),false,'logo') : getDefaultLogo()}}"
                                        class="img-thumbnail img-70 object-contain" id="default_logo_preview" />
                                </label>
