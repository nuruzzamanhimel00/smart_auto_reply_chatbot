...
return [
    ...
    'parameters' => [
        ...
        'language' => [
            'paginate' => [
                'previous' => '<i class="mdi mdi-chevron-left"></i>', // Left arrow icon for Previous
                'next' => '<i class="mdi mdi-chevron-right"></i>',    // Right arrow icon for Next
            ],
            'search' => '',
    ...
    'generator' => [
         ...
         */
        'buttons' => 'create,excel,csv,pdf,print,reset,reload',
